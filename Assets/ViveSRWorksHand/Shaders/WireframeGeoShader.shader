Shader "SRWorksHand/Wireframe"
{
    //TODO: integrate with ViveSR/Wireframe to handle not drawing wire
	Properties
    {
    ...
    {	
        ...
        Pass
        {
            ...
            float4 frag (g2f i) : SV_Target
            {
                ...
                fixed4 finalColor = bgColor;// lerp(bgColor, _Color, t); // disable drawing wire
